...
express()
    ...
    .get('/', async(req, res) => {
        ...
        try {
            ...
            const result = await client.query('SELECT id, sensor, volume, timestamp FROM readings');
    ...
    .post('/dbpost', async(req, res) => {
        ...
        try {
            ...
            */
            ...
            client.query(`INSERT INTO readings (sensor,volume,timestamp) VALUES ('${sensor}', '${volume}',  '${ts}');`, (err, res) => {
                try {
                    if (err) throw err;
                } catch {
